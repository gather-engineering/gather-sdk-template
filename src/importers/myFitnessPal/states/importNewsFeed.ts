...
export const importNewsFeedState = {
  [MY_FITNESS_PAL_IMPORT_FLOW_STATES.IMPORT_NEWSFEED]: {
    invoke: {
      ...
      onError: {
        ...
        actions: (context: any, event: any) => {
          ...
          errorLogger.captureException(event.data, {
            ...
            action: event.data?.action || MY_FITNESS_PAL_IMPORT_FLOW_STATES.IMPORT_NEWSFEED,
