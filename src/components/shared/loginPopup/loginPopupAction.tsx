  ...
  if (state?.errorState) {
    return (
      ...
      >
        ...
        {state?.errorMsg && (
          <code style={{ color: "#B71D18" }}>{state?.errorMsg}</code>
        )}
        <Button
          size="small"
          variant="text"
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Please finish logging in to {dataSourceTitle}. We will request
              your data from {dataSourceTitle} once you are logged in.
            </Typography>
          </Box>
          <Button
            size="small"
  ...
  if (state?.importState === ImportState.REQUEST_EMAIL_AUTHENTICATION) {
    return (
      ...
      >
        ...
        >
          Data request sent. We’ll let you know when {dataSourceTitle} replies
          to your data request. You may have to connect your gmail if you
          haven’t already.
        </Typography>
      </Box>
    );
    ...
    return (
      ...
      >
        ...
        <Typography
          ...
          styles={{ color: "#087443", marginLeft: "10px", textAlign: "left" }}
        >
          SUCCESS! Go check out {"Raw Data"} to see your {dataSourceTitle} data
          in all of its glory.
        </Typography>
      </Box>
    );
